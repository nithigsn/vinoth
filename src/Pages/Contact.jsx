        ...
        <div className='flex h-[80vh] w-full justify-center'>
            ...
            <div className="flex flex-col  items-center w-[90vw] lg:w-[60vw]">
                ...
                <div className="flex flex-col justify-center mt-4 text-sm ">
                    ...
                    <a href="https://www.tiktok.com/@vinothjeyasabesan" className='flex items-center gap-1'>Checkout my Tiktok  <i className="fa-brands fa-tiktok text-2xl cursor-pointer pl-7" style={{ color: "#c7cfdb", }}></i> </a>
