            ...
            <div className="w-[90vw] h-full flex flex-col mt-8 items-center  lg:w-[66vw] justify-center">
                ...
                <div className="flex  flex-col  gap-y-1 ">
                    ...
                    <div className='flex gap-[3px] flex-wrap    '>
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689122/VIN_2331_bqlqfa.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689121/VIN_2250_eybypb.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689122/VIN_2305_rtgck8.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689122/VIN_2265_gt6pt5.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                    ...
                    <div className='flex gap-[3px] flex-wrap    '>
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689122/VIN_2272_n9iyug.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689123/VIN_2343_mo5th7.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689121/VIN_2256_znvbfp.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[343px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                    ...
                    <div className="flex gap-x-1 ">
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689125/VIN_2387_kshtte.jpg" alt="" className='w-[29.4vw] h-[200px] sm:h-[285px] sm:w-[271px] md:h-[330px] lg:h-[500px] lg:w-[337px]' data-aos='zoom-in' />
                    ...
                    <div className='flex gap-1 flex-wrap '>
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689125/VIN_2416_iggapj.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[340px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689128/VIN_2519_a4k7xr.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[340px] md:h-[510px] lg:w-[250px] lg:h-[400px]  sm:hidden lg:block' data-aos="zoom-in" />
                    ...
                    <div className="flex gap-x-1 ">
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689127/VIN_2492_stihjd.jpg" alt="" className='w-[29.4vw] h-[200px] sm:h-[285px] sm:w-[271px] md:h-[330px] lg:h-[500px] lg:w-[337px]' data-aos='zoom-in' />
                    ...
                    <div className='flex gap-1 flex-wrap '>
                        ...
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689132/VIN_2733_wnrjwb.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[340px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
                        <img src="https://res.cloudinary.com/doqdlneyl/image/upload/v1725689132/VIN_2738_kymye9.jpg" alt="" className='w-[188.5px] h-[300px] md:w-[340px] md:h-[510px] lg:w-[250px] lg:h-[400px] ' data-aos="zoom-in" />
